      ...
      <div class="row">
         <div class="col-lg-6 col-md-6 col-12">
            <div class="consultation-form">
               ...
               <form id="contactform" onsubmit="return contactForm()" method="POST" class="form" autocomplete="off">
                  ...
                  <div id="error_message">
                     ...
                     <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                           <input type="text" name="name" class="form-control" onkeypress="isInputNumber(event)" placeholder="Enter Your Name*" id="name" required="">
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                     ...
                     <div class="col-12">
                        ...
                        <div class="form-group button">	
                           <input type="submit"  name="contactus" class="btn" onclick="myFunction()" value="Submit"/>
                        </div>
                     </div>
                  </div>
               </form>
